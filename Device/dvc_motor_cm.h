 ...
 * 
 */
#ifndef MODULES_MOTOR_CM_H_
#define MODULES_MOTOR_CM_H_
...
enum MotorCmStatus
{
    MOTOR_CM_STATUS_DISABLE = 0,
    MOTOR_CM_STATUS_ENABLE,
};
 ...
 *
 */
enum MotorCmMotorId1To4 : uint8_t
{
    MOTOR_CM_ID_0x301 = 1,
    MOTOR_CM_ID_0x302,
    MOTOR_CM_ID_0x303,
 ...
 *
 */
enum MotorCmControlStatusNormal
{
    MOTOR_CM_CONTROL_STATUS_DISABLE = 0x0,
    MOTOR_CM_CONTROL_STATUS_ENABLE,
    MOTOR_CM_CONTROL_STATUS_OVERVOLTAGE = 0x8,
    MOTOR_CM_CONTROL_STATUS_UNDERVOLTAGE,
    MOTOR_CM_CONTROL_STATUS_OVERCURRENT,
    MOTOR_CM_CONTROL_STATUS_MOS_OVERTEMPERATURE,
    MOTOR_CM_CONTROL_STATUS_ROTOR_OVERTEMPERATURE,
    MOTOR_CM_CONTROL_STATUS_LOSE_CONNECTION,
    MOTOR_CM_CONTROL_STATUS_MOS_OVERLOAD,
};
 ...
 *
 */
enum MotorCmControlMethod
{
    MOTOR_CM_CONTROL_METHOD_NORMAL_MIT = 0,
    MOTOR_CM_CONTROL_METHOD_NORMAL_ANGLE_OMEGA,
    MOTOR_CM_CONTROL_METHOD_NORMAL_OMEGA,
    MOTOR_CM_CONTROL_METHOD_NORMAL_EMIT,
    MOTOR_CM_CONTROL_METHOD_1_TO_4_CURRENT,
    MOTOR_CM_CONTROL_METHOD_1_TO_4_OMEGA,
    MOTOR_CM_CONTROL_METHOD_1_TO_4_ANGLE,
};
 ...
 *
 */
struct MotorCmCanTxDataNormalMit
{
 ...
 *
 */
struct MotorCmCanTxDataNormalAngleOmega
{
 ...
 *
 */
struct MotorCmCanTxDataNormalOmega
{
    float control_omega_;
} __attribute__((packed));
 ...
 *
 */
struct MotorCmCanTxDataNormalEmit
{
    float control_angle;
    // 限定速度用, rad/s的100倍
 ...
 *
 */
struct MotorCmRxDataNormal
{
    enum MotorCmControlStatusNormal control_status;
    float now_angle;
    float now_omega;
    float now_torque;
...
public:
  void Init(CAN_HandleTypeDef *hcan,
            uint8_t can_rx_id,
            uint8_t can_tx_id,
            MotorCmControlMethod motor_dm_control_method =
                MOTOR_CM_CONTROL_METHOD_NORMAL_MIT,
    ...
    inline enum MotorCmStatus GetStatus();

    inline enum MotorCmControlStatusNormal GetControlStatus();
    ...
    inline enum MotorCmControlMethod GetControlMethod();
...
protected:
    ...
    // 电机状态
    MotorCmStatus motor_dm_status_ = MOTOR_CM_STATUS_DISABLE;
    // 电机对外接口信息
    MotorCmRxDataNormal rx_data_;
    ...
    // 电机控制方式
    MotorCmControlMethod motor_dm_control_method_ = MOTOR_CM_CONTROL_METHOD_NORMAL_MIT;
...
public:
    ...
    inline MotorCmStatus GetStatus();
    ...
    inline MotorCmControlMethod GetControlMethod();
    ...
    inline void SetControlMethod(MotorCmControlMethod dm_motor_control_method);
...
protected:
    ...
    // 电机控制方式
    MotorCmControlMethod motor_dm_control_method_ = MOTOR_CM_CONTROL_METHOD_1_TO_4_ANGLE;
    // 目标的角度
 ...
 * @return float 角度最大值
 */
inline float MotorCmNormal::GetAngleMax()
{
    return (angle_max_);
}
 ...
 * @return float 角速度最大值
 */
inline float MotorCmNormal::GetOmegaMax()
{
    return (omega_max_);
}
 ...
 * @return float 扭矩最大值
 */
inline float MotorCmNormal::GetTorqueMax()
{
    return (torque_max_);
}
 ...
 * @return float 电流最大值
 */
inline float MotorCmNormal::GetCurrentMax()
{
    return (current_max_);
}
 ...
 * @brief 获取电机状态
 *
 * @return MotorCmStatus 电机状态
 */
inline MotorCmStatus MotorCmNormal::GetStatus()
{
 ...
 */
inline MotorCmControlStatusNormal MotorCmNormal::GetControlStatus()
{
 ...
 * @return float 当前角度
 */
inline float MotorCmNormal::GetNowAngle()
{
 ...
 * @return float 当前角速度
 */
inline float MotorCmNormal::GetNowOmega()
{
 ...
 * @return float 当前扭矩
 */
inline float MotorCmNormal::GetNowTorque()
{
 ...
 */
inline float MotorCmNormal::GetNowMosTemperature()
{
 ...
 * @return float 当前转子温度
 */
inline float MotorCmNormal::GetNowRotorTemperature()
{
 ...
 * @brief 获取电机控制方式
 *
 * @return MotorCmControlMethod 电机控制方式
 */
inline MotorCmControlMethod MotorCmNormal::GetControlMethod()
{
 ...
 */
inline float MotorCmNormal::GetControlAngle()
{
 ...
 */
inline float MotorCmNormal::GetControlOmega()
{
 ...
 */
inline float MotorCmNormal::GetControlTorque()
{
 ...
 */
inline float MotorCmNormal::GetControlCurrent()
{
 ...
 */
inline float MotorCmNormal::GetKp()
{
    return (k_p_);
}
 ...
 */
inline float MotorCmNormal::GetKd()
{
    return (k_d_);
}
 ...
 */
inline void MotorCmNormal::SetControlAngle(float control_angle)
{
 ...
 */
inline void MotorCmNormal::SetControlOmega(float control_omega)
{
 ...
 */
inline void MotorCmNormal::SetControlTorque(float control_torque)
{
 ...
 */
inline void MotorCmNormal::SetControlCurrent(float control_current)
{
 ...
 */
inline void MotorCmNormal::SetKp(float k_p)
{
    k_p_ = k_p;
}
 ...
 */
inline void MotorCmNormal::SetKd(float k_d)
{
    k_d_ = k_d;
}
 ...
 * @return float 电流最大值
 */
inline float MotorCm1To4::GetCurrentMax()
{
    return (current_max_);
}
 ...
 */
inline float MotorCm1To4::Get_TheoreticalOutputCurrentMax()
{
 ...
 * @return MotorCmStatus 电机状态
 */
inline MotorCmStatus MotorCm1To4::GetStatus()
{
    return (motor_dm_status_);
}
 ...
 * @return float 当前角度
 */
inline float MotorCm1To4::GetNowAngle()
{
    return (rx_data_.now_angle);
}
 ...
 * @return float 当前角速度
 */
inline float MotorCm1To4::GetNowOmega()
{
    return (rx_data_.now_omega);
}
 ...
 * @return float 当前电流
 */
inline float MotorCm1To4::GetNowCurrent()
{
 ...
 * @return float 当前MOS温度
 */
inline float MotorCm1To4::GetNowMosTemperature()
{
    return (rx_data_.now_mos_temperature);
}
 ...
 * @return float 当前转子温度
 */
inline float MotorCm1To4::GetNowRotorTemperature()
{
    return (rx_data_.now_rotor_temperature);
}
 ...
 * @return MotorCmControlMethod 电机控制方式
 */
inline MotorCmControlMethod MotorCm1To4::GetControlMethod()
{
    return (motor_dm_control_method_);
}
 ...
 * @return float 目标的角度
 */
inline float MotorCm1To4::GetTargetAngle()
{
 ...
 */
inline float MotorCm1To4::GetTargetOmega()
{
 ...
 */
inline float MotorCm1To4::GetTargetCurrent()
{
 ...
 */
inline float MotorCm1To4::GetFeedforwardOmega()
{
 ...
 */
inline float MotorCm1To4::GetFeedforwardCurrent()
{
 ...
 */
inline void MotorCm1To4::SetControlMethod(MotorCmControlMethod dm_motor_control_method)
{
 ...
 */
inline void MotorCm1To4::SetTargetAngle(float target_angle)
{
 ...
 */
inline void MotorCm1To4::SetTargetOmega(float target_omega)
{
 ...
 */
inline void MotorCm1To4::SetTargetCurrent(float target_current)
{
 ...
 */
inline void MotorCm1To4::SetFeedforwardOmega(float feedforward_omega)
{
 ...
 */
inline void MotorCm1To4::SetFeedforwardCurrent(float feedforward_current)
{
